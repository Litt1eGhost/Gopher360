...
void ConfigFile::ExtractKeys()
{
	...
	if (!file)
	{
		...
		outfile << "CONFIG_DISABLE_VIBRATION = 0x0021 # Disables Gopher Vibrations" << std::endl;
		outfile << "CONFIG_SPEED_CHANGE =  0x0020	# Change speed" << std::endl;
		outfile << "CONFIG_SPEED_CLUTCH =  0x0200	# Change speed temporarily" << std::endl;
		outfile << "\n" << std::endl;
		...
		outfile << "GAMEPAD_RIGHT_THUMB = 0x20" << std::endl;
		outfile << "GAMEPAD_LEFT_SHOULDER = 0xA6" << std::endl;
		outfile << "GAMEPAD_RIGHT_SHOULDER = 0x07	#undefined so it does not disable clutch" << std::endl;
		outfile << "GAMEPAD_A = 0" << std::endl;
		outfile << "GAMEPAD_B = 0x0D" << std::endl;
		outfile << "GAMEPAD_X = 0" << std::endl;
		outfile << "GAMEPAD_Y = 0" << std::endl;
		outfile << "GAMEPAD_TRIGGER_LEFT = 0x11" << std::endl;
		outfile << "GAMEPAD_TRIGGER_RIGHT = 0x09" << std::endl;
		//end cfg dump
